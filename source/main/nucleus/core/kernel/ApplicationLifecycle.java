...
//        }
    ...
    public List<Sniffer> prepareSniffersForOSGiDeployment(String type, 
        ...
        //TangYong Added
        //If the osgi bundle includes META-INF/beans.xml, then also need to add WeldSniffer.
        //[WELD/OSGi Integration]
        Sniffer weldSniffer = snifferManager.getWeldSniffer(context);
        if (weldSniffer != null){
        	sniffers.add(weldSniffer);
        }
