...
public class StockQuoteServlet extends HttpServlet {
    //Inject the OSGi service by using Service<T>
    ...
    public void bindService(@Observes @CDIOSGiEventFilter(StockQuoteService.class) 
    ...
    public void unbindService(@Observes @CDIOSGiEventFilter(StockQuoteService.class) 
