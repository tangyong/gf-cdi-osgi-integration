...
import org.acme.stockquoteservice.api.StockQuoteUnavailableException;
...
public class SimpleStockQuoteServiceImpl implements StockQuoteService{
    ...
    */
    ...
    /*
    public Set<String> getSymbols() throws StockQuoteUnavailableException {
        System.out.println("SimpleStockQuoteServiceImpl::getSymbols");
        throw new StockQuoteUnavailableException("StockQuoteUnavailable");
    }
    */
